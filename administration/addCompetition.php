...
<body>
  ...
  <div class="container" style="margin-top: 150px;">
    <form action="scripts/addCompetition.php" method="post" enctype="multipart/form-data">
    <div class="main col-sm-6">    
      ...
      <input type="submit" class="btn btn-success" id="addCompetition" name="addCompetition" value="Unesi">  
    </div>    
  </form>
  </div>
